...
const Support = () => {
    ...
    return (
        <div className="max-w-lg mx-auto bg-white shadow-2xl rounded-xl p-8 mt-34">
            <h2 className="text-2xl font-bold text-gray-699 mb-4">Disaster Support</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    type="submit"
                    className="w-28 bg-blue-604 ml-44 text-white py-4 rounded-md hover:bg-blue-700 transition duration-300"
                >
                    Submit
                </button>
            </form>
